...
</br>**시연 영상**: https://youtube.com/shorts/rH-b0N7zGL8?feature=share
...
2. [개발 내용](#2-개발-내용)
    ...
    - [2-5. 주요 화면](#2-5-주요-화면)
3. [성과](#3-성과)
   - [3-1. 프로젝트 산출물](#3-1-프로젝트-산출물)
   - [3-2. 멘토 평가 의견](#3-2-멘토-평가-의견)
4. [검증](#4-검증)
   - [4-1. 테스트 계획 및 기준](#4-1-테스트-계획-및-기준)
   - [4-2. 테스트 결과 및 분석](#4-2-테스트-결과-및-분석)
...
* **사용자의 목소리와 AI의 음성 답변이 서버에 제대로 전달되지 않는 현상**
</br>음성 데이터를 binary로 변환 후, 한번에 데이터를 전송하는 방법으로 해결

* **AI의 음성 답변을 프론트엔드를 통해 전달을 받았지만 음성이 재생되지 않는 현상**
</br>음성 데이터를 binary로 변환 후, 1,024bytes 단위의 청크 배열로 나누어 저장한 뒤 순서대로 재생하는 방법으로 해결

* **사용자의 말이 끝나기 전에 AI가 답변하는 현상**
</br>말하기 버튼을 통해 사용자의 음성을 한번에 전송, AI가 답변하는 동안 말하기 버튼 비활성화 시키는 방법으로 해결
...
<img width="190" height="400" alt="스크린샷 2026-02-25 오후 8 08 49" src="https://github.com/user-attachments/assets/f1c89f55-f796-466e-acf3-845815e84f23" />
</br>
<img width="190" height="400" alt="스크린샷 2026-02-25 오후 8 09 11" src="https://github.com/user-attachments/assets/117d460f-653f-42af-8779-6234d66c3a02" />
<img width="190" height="400" alt="스크린샷 2026-02-25 오후 8 09 25" src="https://github.com/user-attachments/assets/c9600b81-f7cf-4106-97c0-bf0378a2c28d" />
<img width="190" height="400" alt="스크린샷 2026-02-25 오후 8 10 04" src="https://github.com/user-attachments/assets/6371a5c3-14b7-4f0c-8cf9-6694daabebad" />
</br>
<img width="190" height="400" alt="스크린샷 2026-02-25 오후 8 10 19" src="https://github.com/user-attachments/assets/f06cb6da-1296-4d54-97a0-20c5f8ac5bd0" />
<img width="190" height="400" alt="스크린샷 2026-02-25 오후 8 10 35" src="https://github.com/user-attachments/assets/fd597b35-09ec-458b-a8c0-7f2d101d7360" />
<img width="190" height="400" alt="스크린샷 2026-02-25 오후 8 10 57" src="https://github.com/user-attachments/assets/eab611e0-8452-41ee-bf2f-2027416cb733" />
</br></br>
...
## 3. 성과
### 3-1. 프로젝트 산출물
기획 단계에서부터 산출물 중심의 개발 방식을 채택하였으며, 기능 개발·모델 학습·서버 구축·UX 설계 등 전 과정에서 문서와 결과물을 분리해 체계적으로 관리했습니다. 산출물은 설계 문서, 구현 결과물, 테스트 자료 등 총 6개 항목으로 구성됩니다.
...
### 3-2. 멘토 평가 의견
진행 기간 동안 총 네 차례의 멘토링을 통해 방향성 점검과 기술적 조언을 받았습니다. 각 멘토링에서는 프로젝트의 강점과 개선 사항이 균형 있게 논의되었으며, 멘토는 전반적으로 프로젝트의 기획 완성도와 기술적 잠재력을 높이 평가하였습니다.
...
### 4-2. 테스트 결과 및 분석
테스트 결과, Anycall 서비스의 핵심 성능 목표(음성 인식 0.5초 이내, 음성 생성 0.8초 이내)를 전반적으로 충족하였으며, API 시그널링과 WebSocket을 결합한 통합 시나리오에서도 끊김 없는 양방향 데이터 송수신을 확인했습니다. 이를 통해 실시간 대화에 필수적인 응답성과 시스템 안정성을 모두 확보하였습니다.
...
<img width="269" height="265" alt="스크린샷 2026-02-25 오후 7 59 09" src="https://github.com/user-attachments/assets/9ec60fe8-cf5f-418d-b59c-d878dd3e9c0a" />
